...
// The Global Array For posts to store post data
var posts = [];
...
app.get("/posts/:postName", function(req, res) {
    ...
    //Changes the incoming parameter to small cased

    posts.forEach(function(post) {
        //Also make the stored title in array to lowered cased
...
//Handling the compose page post request here
app.post("/compose", function(req, res) {
    //Getting the post title and body into My JS Object
    const post = {
